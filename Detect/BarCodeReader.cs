...
namespace NirIdentifier.Detect
{
    ...
    {  
        ...
        HookProc hookDelegate = null;

        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)  
        {
            //为了不出现警告错误用
            EventMsg tempmsg = new EventMsg();
            tempmsg.hwnd = 0;
            tempmsg.paramH = 0;
            tempmsg.message = 0;
            tempmsg.paramL = 0;
        ...
        {  
            if (hKeyboardHook == 0)  
            {
                hookDelegate = new HookProc(KeyboardHookProc);
                //WH_KEYBOARD_LL = 13  
                ...
                hKeyboardHook = SetWindowsHookEx(13, hookDelegate, IntPtr.Zero, 0);  
            }  
